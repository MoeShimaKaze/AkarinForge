...
public abstract class Biome extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<Biome>
{
    ...
    public void plantFlower(World world, Random rand, BlockPos pos)
    {
        ...
        org.bukkit.craftbukkit.event.CraftEventFactory.handleBlockGrowEvent(world, pos.getX(), pos.getY(), pos.getZ(), flower.state.getBlock(), flower.state.getBlock().getMetaFromState(flower.state)); // Akarin Forge
    }
