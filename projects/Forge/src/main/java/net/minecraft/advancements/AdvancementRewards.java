...
public class AdvancementRewards
{
    ...
    public void apply(final EntityPlayerMP player)
    {
        ...
        if (functionobject != null)
        {
            ...
            @RequiredArgsConstructor public static class AdvancementCommandListener implements ICommandSender {
                private final EntityPlayerMP player; private final MinecraftServer minecraftserver;
