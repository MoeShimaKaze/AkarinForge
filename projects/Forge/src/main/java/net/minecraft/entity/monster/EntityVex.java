...
public class EntityVex extends EntityMob
{
    ...
    class AICopyOwnerTarget extends EntityAITarget
    {
        ...
        public void startExecuting()
        {
            EntityVex.this.setAttackTarget(EntityVex.this.owner.getAttackTarget(), org.bukkit.event.entity.EntityTargetEvent.TargetReason.OWNER_ATTACKED_TARGET, true); // CraftBukkit
