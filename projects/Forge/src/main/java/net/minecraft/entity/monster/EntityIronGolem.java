...
public class EntityIronGolem extends EntityGolem
{
    ...
    protected void collideWithEntity(Entity entityIn)
    {
        ...
        {
            this.setAttackTarget((EntityLivingBase)entityIn, org.bukkit.event.entity.EntityTargetLivingEntityEvent.TargetReason.COLLISION, true); // CraftBukkit - set reason
        }
