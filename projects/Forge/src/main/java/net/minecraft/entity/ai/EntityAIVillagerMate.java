...
public class EntityAIVillagerMate extends EntityAIBase
{
    ...
    private void giveBirth()
    {
        ...
        if (org.bukkit.craftbukkit.event.CraftEventFactory.callEntityBreedEvent(entityvillager, this.villager, this.mate, null, null, 0).isCancelled()) return; // CraftBukkit - call EntityBreedEvent
