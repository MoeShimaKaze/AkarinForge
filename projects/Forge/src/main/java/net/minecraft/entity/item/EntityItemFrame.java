...
public class EntityItemFrame extends EntityHanging
{
    ...
    public boolean attackEntityFrom(DamageSource source, float amount)
    {
        ...
        else if (!source.isExplosion() && !this.getDisplayedItem().isEmpty())
        {
            ...
            {
                if (org.bukkit.craftbukkit.event.CraftEventFactory.handleNonLivingEntityDamageEvent(this, source, amount, false) || this.isDead) return true; // CraftBukkit - fire EntityDamageEvent
