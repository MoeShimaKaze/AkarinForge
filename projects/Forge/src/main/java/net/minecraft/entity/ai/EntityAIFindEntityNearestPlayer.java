...
public class EntityAIFindEntityNearestPlayer extends EntityAIBase
{
    ...
    {
        this.entityLiving.setAttackTarget(this.entityTarget, org.bukkit.event.entity.EntityTargetEvent.TargetReason.CLOSEST_PLAYER, true); // CraftBukkit - added reason
