...
{
    public static final DataParameter<ItemStack> FIREWORK_ITEM = EntityDataManager.<ItemStack>createKey(EntityFireworkRocket.class, DataSerializers.ITEM_STACK); // Akarin Forge - public
    ...
    public int lifetime; // Akarin Forge - public
