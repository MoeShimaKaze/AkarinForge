...
public class EntityCreeper extends EntityMob
{
    ...
    public int fuseTime = 30; // CraftBukkit - private -> public
    public int explosionRadius = 3; // CraftBukkit - private -> public
    ...
    public void onStruckByLightning(EntityLightningBolt lightningBolt)
    {
        ...
        // CraftBukkit start
        if (org.bukkit.craftbukkit.event.CraftEventFactory.callCreeperPowerEvent(this, lightningBolt, org.bukkit.event.entity.CreeperPowerEvent.PowerCause.LIGHTNING).isCancelled()) return;
