            ...
            public void updateTask()
            {
                ...
                if (entitylivingbase.getDistanceSq(this.parentEntity) < 4096.0D && this.parentEntity.canEntityBeSeen(entitylivingbase))
                {
                    ...
                    if (this.attackTimer == 20)
                    {
                        ...
                        entitylargefireball.bukkitYield = entitylargefireball.explosionPower = this.parentEntity.getFireballStrength(); // CraftBukkit - set bukkitYield when setting explosionpower
