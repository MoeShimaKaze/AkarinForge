...
public class BlockCactus extends Block implements net.minecraftforge.common.IPlantable
{
        ...
        if (worldIn.isAirBlock(blockpos))
        {
            ...
            if (i < 3)
            {
                ...
                if (j == 15)
                {
                    ...
                    org.bukkit.craftbukkit.event.CraftEventFactory.handleBlockGrowEvent(worldIn, blockpos.getX(), blockpos.getY(), blockpos.getZ(), this, 0); // CraftBukkit
    ...
    {
        org.bukkit.craftbukkit.event.CraftEventFactory.blockDamage = worldIn.getWorld().getBlockAt(pos.getX(), pos.getY(), pos.getZ()); // CraftBukkit
