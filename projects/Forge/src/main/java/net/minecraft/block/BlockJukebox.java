...
public class BlockJukebox extends BlockContainer
{
    ...
    public void dropRecord(World worldIn, BlockPos pos, IBlockState state) // Akarin Forge - public
    {
        if (!worldIn.isRemote)
        {
            TileEntity tileentity = worldIn.getTileEntity(pos);
    ...
    public static class TileEntityJukebox extends TileEntity
        {
            ...
            {
                if (!recordStack.isEmpty()) recordStack.setCount(1); // CraftBukkit - There can only be one
