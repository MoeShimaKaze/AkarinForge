...
public class BlockPumpkin extends BlockHorizontal
{
    ...
    private void trySpawnGolem(World worldIn, BlockPos pos)
    {
        ...
        org.bukkit.craftbukkit.util.BlockStateListPopulator blockList = new org.bukkit.craftbukkit.util.BlockStateListPopulator(worldIn.getWorld()); // CraftBukkit - Use BlockStateListPopulator
        if (blockpattern$patternhelper != null)
        {
            ...
            if (worldIn.addEntity(entitysnowman, org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason.BUILD_SNOWMAN)) { // CraftBukkit
        ...
        else
        {
            ...
            if (blockpattern$patternhelper != null)
            {
                ...
                if (worldIn.addEntity(entityirongolem, org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason.BUILD_IRONGOLEM)) { // CraftBukkit
                blockList.updateList(); // CraftBukkit
