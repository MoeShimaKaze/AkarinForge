...
public class BlockStem extends BlockBush implements IGrowable
{
        ...
        if (worldIn.getLightFromNeighbors(pos.up()) >= 9)
        {
            ...
            if(net.minecraftforge.common.ForgeHooks.onCropsGrowPre(worldIn, pos, state, rand.nextInt((int)(25.0F / f) + 1) == 0))
            {
                ...
                if (i < 7)
                {
                    ...
                    org.bukkit.craftbukkit.event.CraftEventFactory.handleBlockGrowEvent(worldIn, pos.getX(), pos.getY(), pos.getZ(), this, getMetaFromState(newState)); // CraftBukkit
                }
                else
                {
                    for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL)
                    ...
                    {
                        org.bukkit.craftbukkit.event.CraftEventFactory.handleBlockGrowEvent(worldIn, pos.getX(), pos.getY(), pos.getZ(), this.crop, 0); // CraftBukkit
                    }
                }
    ...
    public void growStem(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        org.bukkit.craftbukkit.event.CraftEventFactory.handleBlockGrowEvent(worldIn, pos.getX(), pos.getY(), pos.getZ(), this, Math.min(7, i)); // CraftBukkit
    }
